...
func TestRequestValidCepAndKey(t *testing.T) {
    Request := NewRequest("91040300", "alsdjladadlkajdkljalkdjalksjdkl")
...
func TestRequestViaCepInvalido(t *testing.T) {
    Request := NewRequest("00000000", "alsdjladadlkajdkljalkdjalksjdkl")
...
func TestRequestTemperatura(t *testing.T) {
    Request := NewRequest("91040300", "545c605410b74c09a2921907241506")
